...
mov ch,0x0F   ;the character attribute
mov dx,0x0420 ;x,y position of where text should start on screen
...
add dh,1
mov dl,0
mov dl,[line_start_x] ;load position of x position the next line starts on
...
mov ax,website ;the string we intend to write to video RAM
mov dx,0x1718
call putstring_vram
...
v_str db 'This program prints all 256 characters in DOS using Assembly language!',0
website db 'https://chastitywhiterose.com/',0
