...
The emulation was successful. I booted from the .iso installation for FreeBSD and installed it to the 16 GB disk that was created. After the installation, I rebooted and then it automatically knew to boot from the disk rather than the ISO this time.
